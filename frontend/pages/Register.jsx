    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md border-gray-200">
        ...
        <form onSubmit={handleSubmit}>
              <div className="mb-4">
             <label className="block text-gray-600 text-sm font mb-1">Username</label>
            <input
          ...
          <button className="w-full bg-blue-500 text-white p-3 rounded-md hover:bg-blue-600 font-medium cursor-pointer mb-5">
            Register
          </button>
